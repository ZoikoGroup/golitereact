...
export default function MarineDiscountEnrollment() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const ngo_name = form.ngo_name.value.trim();
    ...
    if (!ngo_name) newErrors.ngo_name = "NGO Name is required";
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-8">
           As a thank-you for your dedication to protecting marine life, we offer exclusive discounts on our plans. Stay connected while making a difference!
          </p>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  >
                    ...
                    <option>Recent Activity Proof  (Letter from NGO, Event Participation, or Contribution Receipt)</option>
                  </select>
                  {errors.id_type && (
                    <p className="text-red-500 text-sm mt-1">
                      {errors.id_type}
