...
export default function TrustCenter() {
  ...
  return (
    <section className="bg-[#f5f6f7] text-gray-800 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-12 gap-5 mt-6 px-4 pb-16 items-start">
        ...
        {/* ── LEFT SIDEBAR ─────────────────────────────────── */}
        <aside className="col-span-2 bg-white rounded-xl p-3 shadow-sm sticky top-4">
        ...
        <div className="col-span-7 space-y-5">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="font-bold text-base flex items-center gap-2">📊 Overview</h2>
            ...
            <div className="grid grid-cols-2 gap-6 text-sm">
              ...
              <div className="space-y-2 bg-gray-50 rounded-xl p-4">
                <div className="flex justify-between border-b border-gray-100 pb-2">
                  <span className="text-gray-500">Active Certifications</span>
                  <span className="font-bold text-green-600">5</span>
                </div>
                <div className="flex justify-between border-b border-gray-100 pb-2">
                  <span className="text-gray-500">Compliance Frameworks</span>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <p className="text-xs text-gray-400 mb-5">Active certifications and current compliance status of GoLite's key frameworks.</p>
          ...
          {/* SECURITY */}
          <div className="bg-[#0f1c2e] p-6 rounded-xl shadow-sm text-white">
            <h2 className="font-bold text-base mb-1 flex items-center gap-2">🔐 Security</h2>
            <p className="text-xs text-gray-400 mb-5">Architecture, controls, and operational security. GoLite Mobile.</p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <p className="text-xs text-gray-400 mb-5">GoLite Mobile processes and protects data with rights.</p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <p className="text-xs text-gray-400 mb-5">AI ethics, explainability, and responsible deployment — GoLite Mobile.</p>
            <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <p className="text-xs text-gray-400 mb-5">Regulatory risk management and framework coverage.</p>
            <div className="space-y-3">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <p className="text-xs text-gray-400 mb-5">Internal governance policies, available for public review.</p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="font-bold text-base flex items-center gap-2">📂 Compliance Documents</h2>
              <button className="text-xs bg-blue-500 text-white px-3 py-1.5 rounded-full font-semibold hover:bg-blue-600 transition-colors">
                Request Access
              </button>
            </div>

            <div className="rounded-xl border border-gray-200 overflow-hidden">
              <div className="grid grid-cols-12 bg-[#0f2244] text-white text-xs font-bold px-4 py-3 gap-2">
              ...
              {documents.map((doc, i) => (
                <div
                  key={i}
                  className={`grid grid-cols-12 px-4 py-3 gap-2 text-xs items-center border-b border-gray-100 ${
                    i % 2 === 0 ? "bg-white" : "bg-gray-50"
                  }`}
                >
                  <div className="col-span-4">
                    <p className="font-semibold text-gray-800">{doc.name}</p>
                    {doc.sub && <p className="text-gray-400 text-[11px]">{doc.sub}</p>}
                  </div>
                  ...
                  <div className="col-span-2">
                    <button className={`text-white text-[10px] font-bold px-2 py-1 rounded-full transition-colors ${doc.actionColor}`}>
                      {doc.action}
                    </button>
                  </div>
                </div>
        ...
        <aside className="col-span-3 space-y-4 sticky top-4">
          ...
          <div className="bg-[#0f1c2e] text-white p-4 rounded-xl">
            ...
            <input
              ...
              className="w-full bg-white/10 text-white placeholder-gray-500 text-xs rounded-lg px-3 py-2 mb-2 focus:outline-none focus:ring-1 focus:ring-green-400"
            />
            <button className="bg-green-500 hover:bg-green-600 transition-colors text-white w-full py-2.5 rounded-xl text-sm font-semibold">
