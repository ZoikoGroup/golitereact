...
const documents = [
  ...
  { name: "Terms of Service", sub: "Customer agreement", category: "Legal", categoryColor: "bg-purple-100 text-purple-700", access: "Public", accessColor: "bg-green-100 text-green-700", date: "Feb 2026", action: "Download", actionColor: "bg-green-500 hover:bg-green-600" },

  { name: "Cookie Policy", sub: "Web and app cookie notice", category: "Privacy", categoryColor: "bg-blue-100 text-blue-700", access: "Public", accessColor: "bg-green-100 text-green-700", date: "Feb 2026", action: "Download", actionColor: "bg-green-500 hover:bg-green-600" },

  { name: "Data Processing Agreement (DPA)", sub: "Partner data agreement template", category: "Privacy", categoryColor: "bg-blue-100 text-blue-700", access: "Restricted", accessColor: "bg-orange-100 text-orange-700", date: "Mar 2026", action: "Request Access", actionColor: "bg-orange-500 hover:bg-orange-600" },

  { name: "SOC 2 Type II Report", sub: "Security audit report (qualified partners)", category: "Certification", categoryColor: "bg-green-100 text-green-700", access: "NDA Required", accessColor: "bg-red-100 text-red-700", date: "Jan 2026", action: "Request Access", actionColor: "bg-orange-500 hover:bg-orange-600" },

  { name: "ISO 27001 Certificate", sub: "Certification evidence", category: "Certification", categoryColor: "bg-green-100 text-green-700", access: "Public", accessColor: "bg-green-100 text-green-700", date: "Nov 2025", action: "Download", actionColor: "bg-green-500 hover:bg-green-600" },

  { name: "Penetration Test Summary", sub: "Executive summary — latest pentest", category: "Security", categoryColor: "bg-red-100 text-red-700", access: "NDA Required", accessColor: "bg-red-100 text-red-700", date: "Dec 2025", action: "Request Access", actionColor: "bg-orange-500 hover:bg-orange-600" },

  { name: "Business Continuity Plan Summary", sub: "BCP executive summary", category: "Risk", categoryColor: "bg-yellow-100 text-yellow-700", access: "Restricted", accessColor: "bg-orange-100 text-orange-700", date: "Sep 2025", action: "Request Access", actionColor: "bg-orange-500 hover:bg-orange-600" },

  { name: "AI Ethics & Governance Policy", sub: "Public policy document", category: "AI", categoryColor: "bg-indigo-100 text-indigo-700", access: "Public", accessColor: "bg-green-100 text-green-700", date: "Mar 2026", action: "Download", actionColor: "bg-green-500 hover:bg-green-600" },

  { name: "Subprocessor List", sub: "Approved third-party processors", category: "Privacy", categoryColor: "bg-blue-100 text-blue-700", access: "Public", accessColor: "bg-green-100 text-green-700", date: "Feb 2026", action: "Download", actionColor: "bg-green-500 hover:bg-green-600" },

  { name: "Cyber Essentials Plus Certificate", sub: "UK government certification", category: "Certification", categoryColor: "bg-green-100 text-green-700", access: "Public", accessColor: "bg-green-100 text-green-700", date: "Oct 2025", action: "Download", actionColor: "bg-green-500 hover:bg-green-600" },

  { name: "Annual Sustainability Report", sub: "ESG & blue economy report", category: "ESG", categoryColor: "bg-teal-100 text-teal-700", access: "Public", accessColor: "bg-green-100 text-green-700", date: "Jan 2026", action: "Download", actionColor: "bg-green-500 hover:bg-green-600" },
];
...
<h1 className="text-xl dark:bg-gray-900 dark:text-white text-gray-500 leading-relaxed mb-2">Your Data Rights </h1>
