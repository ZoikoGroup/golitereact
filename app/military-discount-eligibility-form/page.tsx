      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-8">
           Verify your military status to receive exclusive discounts on your mobile plan. Please provide valid proof of service to qualify. <b>This is applicable for active Army Personnel & Army Veterans.</b>
          </p>
