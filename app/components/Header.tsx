    ...
    <nav className="w-full border-b bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-gray-600 dark:text-gray-300">
          <a href="/prepaid" className="hover:text-black dark:hover:text-white">
            Prepaid Plans
          </a>
          <a
            href="/postpaid"
          ...
          <a href="/phones" className="hover:text-black dark:hover:text-white">
            Phones
          </a>
      ...
      {menuOpen && (
        <div className="md:hidden border-t bg-white px-6 py-4 space-y-4">
          <a href="/prepaid" className="block">
            Prepaid Plans
          </a>
          <a href="/postpaid" className="block">
            Postpaid Plans
          </a>
          <a href="/family-plans" className="block">
            Family Plans
          </a>
          <a href="/business" className="block">
            Business Plans
          </a>
          <a href="/community-plans" className="block">
            Community Plans
          </a>
