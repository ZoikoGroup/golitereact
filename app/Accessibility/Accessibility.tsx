    ...
    <div className="bg-white text-gray-900 font-sans">
      ...
      <section className="max-w-6xl mx-auto px-4 py-14">
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl font-bold mt-4 mb-1 text-gray-800">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-48 flex-shrink-0">
              <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Select Technology</p>
            ...
            <div className="flex-1 bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <p className="text-sm text-gray-700 leading-relaxed mb-5">{activeTech.content.summary}</p>

              <div className="grid grid-cols-2 gap-4 mb-5">
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-xs text-gray-400 uppercase tracking-wide mb-1">Testing Standard</p>
                  <p className="font-bold text-sm">{activeTech.content.standard}</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-xs text-gray-400 uppercase tracking-wide mb-1">Last Tested</p>
                  <p className="font-bold text-sm">{activeTech.content.lastTested}</p>
                </div>
              </div>

              <div className="mb-5">
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Supported & Tested</p>
              ...
              <div>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Known Limitations</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-white/10 p-6">
            <div className="flex items-center gap-2 mb-5">
              ...
              <div>
                <p className="font-bold text-white text-sm">Display & Interaction Preferences</p>
                <p className="text-xs text-gray-800">All changes apply immediately and persist across sessions.</p>
              </div>
            </div>
              ...
              {settings.map((s, i) => (
                <div key={i} className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-800 leading-relaxed mt-0.5">{s.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-14">
        ...
        <div className="rounded-xl border border-gray-200 overflow-hidden shadow-sm">
          {/* Header */}
          <div className="grid grid-cols-12 bg-[#0f2244] text-white text-xs font-bold px-5 py-3 gap-3">
          ...
          {complianceRows.map((row, i) => (
            <div
              key={i}
              className={`grid grid-cols-12 px-5 py-4 gap-3 text-xs items-start border-b border-gray-100 ${
                i % 2 === 0 ? "bg-white" : "bg-gray-50"
              }`}
            >
              <div className="col-span-4">
                <p className="font-semibold text-gray-800">{row.standard}</p>
                <p className="text-gray-400 text-[11px] mt-0.5">{row.sub}</p>
              </div>
              <div className="col-span-1">
                <span className={`px-2 py-0.5 rounded text-[11px] font-bold ${row.levelColor}`}>
                  {row.level}
                </span>
              </div>
              <div className="col-span-2">
                <span className={`font-bold flex items-center gap-1 ${row.statusColor}`}>
                  <span>{row.icon}</span>
                  {row.status}
                </span>
              </div>
              <div className="col-span-5 text-gray-600 leading-relaxed">{row.note}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-white py-14 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mt-4 mb-1">Accessibility Feedback</h2>
          ...
          <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div>
                <label className="text-xs font-semibold text-gray-600 mb-1 block">Issue Type *</label>
                <select
                  value={formData.issueType}
                  onChange={(e) => setFormData({ ...formData, issueType: e.target.value })}
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-500 focus:outline-none focus:ring-2 focus:ring-green-400"
                >
              ...
              <div>
                <label className="text-xs font-semibold text-gray-600 mb-1 block">Page or Feature Affected</label>
                <input
                  type="text"
